...
export const skills: Skill[] = [
  // Programming Languages
  {
    ...
    certifications: ["Python Professional Certification", "Data Science with Python"],
    color: "#3776AB",
  ...
  },
  {
    ...
    certifications: ["Java Basic Certification"],
    color: "#007396",
  ...
  },
  {
    ...
    certifications: ["C/C++ Basic Certification"],
    color: "#00599C",
  ...
  // Frameworks & Libraries
  {
    ...
    certifications: ["Application Development Training"],
    color: "#02569B",
  ...
  },
  {
    ...
    certifications: ["SQL Basic Certification"],
    color: "#4479A1",
